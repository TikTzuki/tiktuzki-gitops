...
A Helm chart for TimescaleDB - The Open Source Time-Series Database for PostgreSQL. TimescaleDB is built on PostgreSQL
and provides advanced time-series capabilities including automatic partitioning, columnar compression, continuous
aggregates, and more.
...
The command deploys TimescaleDB on the Kubernetes cluster in the default configuration.
